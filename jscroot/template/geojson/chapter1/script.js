export function main() {
    function processFeatureRow(table, feature) {
        ...
        if (feature.properties.Alamat && feature.properties.Jalan) {
            nameCell.innerText = `${feature.properties.name}, ${feature.properties.dia}, ${feature.properties.name}`;
        } else if (feature.properties.dia) {
    ...
    fetch("https://raw.githubusercontent.com/isnaenti/tugasgis/main/chapter1/polygon.json")
